...
import SchedulePage from "../../SubPage/CalendarPage/SchedulePage";
...
const ContentsPageSubContainer = styled.div`
  ...
  flex-direction: column;
`;
const ContentsPage02 = () => {
  return (
    <ContentsPageContainer>
      <MenuPage />
      <ResponsiveMenuPage />
      <ContentsPageSubContainer>
        {localStorage.getItem("loginFlag") === "true" && <SchedulePage />}
      </ContentsPageSubContainer>
    </ContentsPageContainer>
  );
};

export default ContentsPage02;
